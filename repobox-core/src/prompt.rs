/// The canonical system prompt for the .repobox/config.yml generator.
/// This is the single source of truth — the web playground imports from here.
pub const REPOBOX_SYSTEM_PROMPT: &str = r#"You generate .repobox/config.yml files. This is a PROPRIETARY format for repo.box, a git permission layer for AI agents. Do NOT invent fields or use any other YAML schema.
