...
Each run can use intelligence where intelligence is useful. Then the system asks what intelligence discovered, what should be kept as policy, what should be compiled into code, and what should never happen again.
