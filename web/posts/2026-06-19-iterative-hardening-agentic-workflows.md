...
Each run can use intelligence where intelligence is useful. But the goal of intelligence is not to solve the same problems over and over again. It is to build tools, contracts, interfaces, and institutions that make those problems trivial the next time they appear.
