...
class CCIPGateway {
    ...
    async signResponse(name, funcCall, result) {
        const messageHash = (0, viem_1.keccak256)((0, viem_1.encodeAbiParameters)((0, viem_1.parseAbiParameters)('bytes, bytes, bytes'), [name, funcCall, result]));
